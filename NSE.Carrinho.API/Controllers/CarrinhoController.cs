...
using NSE.Carrinho.API.Model.DTO;
    ...
    public class CarrinhoController : MainController
    {
        ...
        private async Task<CarrinhoCliente> ObterCarrinhoCliente()
        {
            return await _context.CarrinhoCliente
                 .Include(c => c.Itens)
                 .FirstOrDefaultAsync(c => c.ClienteId == _user.ObterUserId()) ?? new CarrinhoCliente();
        }
        ...
        private async Task<CarrinhoItem> ObterItemCarrinhoValidado(Guid produtoId,  CarrinhoCliente carrinho, ItemCarrinhoDTO item = null)
        {
